...
contract FflonkVerifier {
    ...
    uint256 constant C0x  = 431608728233621095988160985214522804767116301674896402990118502454615248727;
    uint256 constant C0y  = 2581248879873072294163906356881065457310256254233262869359065939220770737776;

    // Verifier preprocessed input x·[1]_2
    uint256 constant X2x1 = 12341169414943573799329451400673576539175945291913177213427192589413520511301;
    uint256 constant X2x2 = 19965553129417455822580404283607236589763731374168248719939729854550472811392;
    uint256 constant X2y1 = 19742044719495957586862232844858672514623809097110830018758294928835848386153;
    uint256 constant X2y2 = 17879872736863486209135433805397974051565840910401723005705963451209633280616;
